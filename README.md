...
Open a browser and navigate to the /events endpoint: http://localhost:8000/events
...
Ping: http://localhost:8000/ping - Returns a simple {"message": "Server is active"} if the server is running.

Health: http://localhost:8000/health - Provides detailed server health information, including uptime, CPU usage, memory usage, and disk usage.
...
Make your changes and commit them: git commit -m "Add your descriptive commit message".
